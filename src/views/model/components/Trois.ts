...
export default class Trois {
    ...
    // 同步淡入
    synchronizeCrossFade(startAction: THREE.AnimationAction, endAction: THREE.AnimationAction, duration: number): void {
    ...
    // 开始淡入
    executeCrossFade(startAction: THREE.AnimationAction, endAction: THREE.AnimationAction, duration: number): void {
    ...
    getActionList(): Array<THREE.AnimationAction> {
        return this.actions;
    }
